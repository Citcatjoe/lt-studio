		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Intro -->
					...
					<section id="one" class="skills wrapper style3 fade-up">
						<div class="inner">
							<h2>Nos médias au service de votre marque</h2>
							<p>
							...
							<div class="features">
								<section>
									...
									<h3>Writing</h3>
									<p>La rédaction de contenus print et digitaux interactifs qui placent le storytelling au cœur du processus de création.</p>
								</section>
								<section>
							...
							<div class="split style1">
								<section>
									...
									<form method="post" action="contact.php">
										...
										<ul class="actions">
											<li><a href="" type="submit" class="button submit"><span>Envoyer</span></a></li>
										</ul>
									</form>
								</section>
								<section>
